    ...
    <div class="bg-primary text-white border border-line rounded-2xl p-6 shadow-none hover:shadow-[0_0_40px_rgba(255,255,255,0.35)] transition">
        ...
        <form method="POST" action="{{ route('colocations.store') }}" class="space-y-4">
            ...
            <div>
                ...
                <textarea name="description" class="w-full px-3 py-2 rounded-xl border border-line bg-white text-black placeholder-gray-500" rows="4">{{ old('description') }}</textarea>
            </div>
